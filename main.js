...
//checks superior inferior y transparencia 
  ...
  /* FILTROS DE ASIDE IMAGEN */

  function cambiarFiltro(){
    let image= document.getElementById("imagen-meme")
    let rango= document.getElementById("filter").value;
    
    image.style.filter="grayscale(" + rango + 10 + "%)"
  }
